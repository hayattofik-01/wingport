...
export default function Banner() {
  ...
  return (
    <div className="sticky top-0 z-50 border-b border-wing-border bg-wing-raised/95 backdrop-blur-sm">
      <div className="mx-auto flex max-w-[1080px] items-center gap-3 px-6 py-2.5">
        <span className="h-full w-1 shrink-0 self-stretch rounded-full bg-wing-warn" aria-hidden="true" />
        ...
        <button
          ...
          className="rounded p-1 text-wing-dim hover:text-wing-text focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wing-signal"
        >
          <X className="h-4 w-4" />
        </button>
      </div>
